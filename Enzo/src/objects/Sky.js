...
class Sky extends Mesh {
    constructor() {
        ...
        // Create a cube-shaped sky
        super(new BoxGeometry(1, 1, 1), material);

        this.isSky = true; // Flag to indicate it's a sky object
    }
}
...
Sky.SkyShader = {
    ...
    vertexShader: /* glsl */`
        ...
        float sunIntensity(float zenithAngleCos) {
            ...
            return EE * max(0.0, 1.0 - pow(2.71828182845904523536028747135266249775724709369995957, -( (cutoffAngle - acos(zenithAngleCos)) / steepness)));
        }
